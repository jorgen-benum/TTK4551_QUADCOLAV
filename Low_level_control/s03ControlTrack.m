function [M_vector] = s03ControlTrack(roll_pitch_yaw_d, omega_d, omega_d_dot, roll_pitch_yaw, omega)
...
M_vector = -k_R.*e_R - k_omega.*e_omega + cross(omega,(I__b_CG*omega)) ...
    - I__b_CG*(Smtrx(omega)*transpose(R)*R_d*omega_d - transpose(R)*R_d*omega_d_dot);
end
